export const Card = ({ title, image, description, to }) => {
  return (
    <div className="flex cursor-pointer flex-col rounded-lg p-4 shadow-lg shadow-slate-400 bg-gray-50 space-y-2 hover:scale-110 hover:shadow-slate-500 duration-200 ease-in">
