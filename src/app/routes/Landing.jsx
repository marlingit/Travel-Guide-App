    ...
    <main role="main" className="space-y-16">
      <section className="pt-20">
        <div className="flex flex-col min-h-[80vh] p-4 sm:flex-row items-center justify-between max-w-6xl mx-auto">
          <div className="max-w-96 flex flex-col sm:block overflow-hidden">
          ...
          <div className="relative w-full sm:w-[65vw] max-w-[700px] aspect-square flex-shrink-0 sm:-mr-24 overflow-hidden">
